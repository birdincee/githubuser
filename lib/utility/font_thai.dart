...
class FontThai {
  ...
  static TextStyle text16BlackNormal = GoogleFonts.sarabun(
  ...
  static TextStyle text18WhiteNormal = GoogleFonts.sarabun(
    textStyle: const TextStyle(
      color: Colors.white,
      letterSpacing: 0.5,
      fontWeight: FontWeight.normal,
  ...
  static TextStyle text18WhiteBold = GoogleFonts.sarabun(
    textStyle: const TextStyle(
      color: Colors.white,
      letterSpacing: 0.5,
      fontWeight: FontWeight.bold,
  ...
  static TextStyle text30WhiteBold = GoogleFonts.sarabun(
    textStyle: const TextStyle(
      color: Colors.white,
      letterSpacing: 0.5,
      fontWeight: FontWeight.bold,
